...
int main() {
  WIN32CONSOLE();
  ponos::RawMesh rm;
  aergia::loadPLY("/run/media/filipecn/OS/Users/fuiri/Desktop/2d.tar/2d/PLY/circle.ply", &rm);
  ...
  app.scene.add(new aergia::HEMeshObject(new ponos::HEMesh2DF(&rm), new aergia::Text("/run/media/filipecn/OS/Windows/Fonts/arial.ttf")));
