...
int main(int /* argc */, char ** /* argv */) {
  circe::SceneApp<> app(800, 800, "Nanogui Example", false);
  app.addViewport2D(0, 0, 800, 800);
  std::shared_ptr<circe::NanoGUIScreen> screen(new circe::NanoGUIScreen());
  // Create nanogui gui
  bool enabled = true;
  FormHelper *gui =
      new FormHelper(dynamic_cast<nanogui::Screen *>(screen.get()));
