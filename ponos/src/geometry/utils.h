...
namespace ponos {
	 ...
	 * @w **[in]** vector
	 * In spherical coordinates **(theta, phi)**. **Theta** is the given direction to the z axis and **phi** is the angle formed with the x axis after projection onto the **xy** plane.
