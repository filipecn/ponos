...
template <typename T> Point3<T> Point3<T>::operator+(const Point3<T> &v) const {
  return Point3(x + v.x, y + v.y, z + v.z);
}
...
template <typename T> Point2<T> Point3<T>::xy() const {
  return Point2<T>(x, y);
}

template <typename T> Point2<T> Point3<T>::yz() const {
  return Point2<T>(y, z);
}

template <typename T> Point2<T> Point3<T>::xz() const {
  return Point2<T>(x, z);
}
...
template <typename T> Point3<T> &Point3<T>::operator*=(T d) {
  x *= d;
  y *= d;
  z *= d;
  return *this;
...
template <typename T> inline Point2<T> operator*(real_t f, const Point2<T> &p) {
  return p * f;
}
