...
namespace helios {
	...
	class Triangle : public Shape {
		public:
			 ...
			 */
			Triangle(const ponos::Transform *o2w, const ponos::Transform *w2o, bool ro, const TriangleMesh *m, uint32 n);
			...
			/* @inherit */
			bool intersect(const HRay &ray, float *tHit, float *rayEpsilon, DifferentialGeometry *dg) const;
			/* @inherit */
